...
export default function Home() {
  ...
  const [isOffline, setIsOffline] = useState(false); // 2. Added offline state
            ...
            renderItem={({ item }) => (
              <View style={styles.videoCard}>
                <View style={styles.videoWrapper}>
                  {/* 4. STEP 3 LOGIC: Conditional Video/Placeholder */}
                  {isOffline ? (
...
const styles = StyleSheet.create({
  ...
  videoWrapper: { borderRadius: 12, overflow: 'hidden', backgroundColor: '#000', height: 200 }, // Fixed height for consistency
